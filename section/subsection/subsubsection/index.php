...
<section id="main">
	<nav class="section-nav" data-role="nav">
		...
		<div class="section-nav-inner">
			<ul>
				<li><a href="/section/subsection">Child Page</a></li>
	...
	<section id="pages" class="high"> <!-- classes are high and medium -->
		<div class="inner">
	 ...
	 <?php include('../../../intra_inc/footer.php');?>
